...
public class RavenParser extends Parser {
	...
	public static final int
		...
		T__365=366, T__366=367, T__367=368, NON_ZERO_DIGIT=369, STRING=370, CRLF=371, 
		Operator=372, WS=373, COMMENT=374, LINE_COMMENT=375, NUMBER=376;
	public static final int
		...
		RULE_radonKvp = 140, RULE_llmJsonParser = 141, RULE_radonBbox = 142, RULE_resource = 143, 
		RULE_json = 144, RULE_obj = 145, RULE_pair = 146, RULE_arr = 147, RULE_jValue = 148;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"radonBbox", "resource", "json", "obj", "pair", "arr", "jValue"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'validationLlm'", "'neonKvp'", "'radonKvp'", "'llmJsonParser'", "'radonBbox'", 
			"','", "':'", "'['", "']'", "'true'", "'false'", "'null'"
		};
	}
	...
	public static class ActionContext extends ParserRuleContext {
		...
		public RadonBboxContext radonBbox() {
			return getRuleContext(RadonBboxContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class RadonBboxContext extends ParserRuleContext {
		public Token name;
		public Token resourceConn;
		public Token endpoint;
		public Token inputTable;
		...
		public RadonBboxContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_radonBbox; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RavenListener ) ((RavenListener)listener).enterRadonBbox(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RavenListener ) ((RavenListener)listener).exitRadonBbox(this);
		}
	}

	public final RadonBboxContext radonBbox() throws RecognitionException {
		RadonBboxContext _localctx = new RadonBboxContext(_ctx, getState());
		enterRule(_localctx, 284, RULE_radonBbox);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			match(T__7);
			setState(3508);
			((RadonBboxContext)_localctx).name = match(STRING);
			setState(3509);
			match(T__165);
			setState(3510);
			((RadonBboxContext)_localctx).resourceConn = match(STRING);
			setState(3511);
			match(T__106);
			setState(3512);
			((RadonBboxContext)_localctx).endpoint = match(STRING);
			setState(3513);
			match(T__302);
			setState(3514);
			((RadonBboxContext)_localctx).inputTable = match(STRING);
			setState(3515);
			match(T__259);
			setState(3516);
			((RadonBboxContext)_localctx).outputTable = match(STRING);
			setState(3517);
			match(T__9);
			setState(3518);
			match(T__1);
			setState(3519);
			((RadonBboxContext)_localctx).querySet = match(STRING);
			setState(3520);
			match(T__2);
			setState(3525);
			_errHandler.sync(this);
			...
			while (_la==T__10) {
				...
				match(T__10);
				setState(3522);
				((RadonBboxContext)_localctx).condition = expression();
				}
				}
				setState(3527);
				_errHandler.sync(this);
