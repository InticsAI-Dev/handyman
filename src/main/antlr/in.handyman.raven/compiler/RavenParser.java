...
public class RavenParser extends Parser {
	...
	public static final int
		...
		RULE_testDataExtractor = 83, RULE_deepSift = 84, RULE_episodeOfCoverage = 85, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"zeroShotClassifierPaperFilter", "assetInfo", "dataExtraction", "testDataExtractor", 
			"deepSift", "episodeOfCoverage", "userRegistration", "authToken", "eocJsonGenerator", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'testDataExtractor'", "'deepSift'", "'episodeOfCoverage'", "'origin-id'", 
	...
	public static class ActionContext extends ParserRuleContext {
		...
		public TestDataExtractorContext testDataExtractor() {
			return getRuleContext(TestDataExtractorContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class TestDataExtractorContext extends ParserRuleContext {
		public Token name;
		public Token resourceConn;
		public Token resultTable;
		public Token endPoint;
		...
		public TestDataExtractorContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_testDataExtractor; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RavenListener ) ((RavenListener)listener).enterTestDataExtractor(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RavenListener ) ((RavenListener)listener).exitTestDataExtractor(this);
		}
	}

	public final TestDataExtractorContext testDataExtractor() throws RecognitionException {
		TestDataExtractorContext _localctx = new TestDataExtractorContext(_ctx, getState());
		enterRule(_localctx, 166, RULE_testDataExtractor);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			match(T__7);
			setState(2289);
			((TestDataExtractorContext)_localctx).name = match(STRING);
			setState(2290);
			match(T__107);
			setState(2291);
			((TestDataExtractorContext)_localctx).resourceConn = match(STRING);
			setState(2292);
			match(T__254);
			setState(2293);
			((TestDataExtractorContext)_localctx).resultTable = match(STRING);
			setState(2294);
			match(T__106);
			setState(2295);
			((TestDataExtractorContext)_localctx).endPoint = match(STRING);
			setState(2296);
			match(T__105);
			setState(2297);
			((TestDataExtractorContext)_localctx).processId = match(STRING);
			setState(2298);
			match(T__9);
			setState(2299);
			match(T__1);
			setState(2300);
			((TestDataExtractorContext)_localctx).querySet = match(STRING);
			setState(2301);
			match(T__2);
			setState(2306);
			_errHandler.sync(this);
			...
			while (_la==T__10) {
				...
				match(T__10);
				setState(2303);
				((TestDataExtractorContext)_localctx).condition = expression();
				}
				}
				setState(2308);
				_errHandler.sync(this);
	...
	public final DeepSiftContext deepSift() throws RecognitionException {
		...
		enterRule(_localctx, 168, RULE_deepSift);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
