...
public class RavenLexer extends Lexer {
	...
	public static final int
		...
		T__359=360, T__360=361, T__361=362, NON_ZERO_DIGIT=363, STRING=364, CRLF=365, 
		Operator=366, WS=367, COMMENT=368, LINE_COMMENT=369, NUMBER=370;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__357", "T__358", "T__359", "T__360", "T__361", "DIGIT", "NON_Z_DIGIT", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'convert-excel-to-database'", "'fileType'", "'faceDetection'", "'figureDetection'", 
			"'Document-parser'", "'urgencyTriageBeta'", "','", "':'", "'['", "']'", 
			"'true'", "'false'", "'null'"
		};
	}
