  ...
  public void execute() throws Exception {
      try {
        ...
        final String insertQuery = "INSERT INTO " + ftpUpload.getResultTable() +
                "(tenant_id, root_pipeline_id, created_date, created_by, last_modified_by, last_modified_date, status, message, type, last_processed_on, ftp_folder_path, destination_path, file_paths, created_on, created_user_id, last_updated_on, last_updated_user_id, version, info)" +
                "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?::jsonb, ?, ?, ?, ?, ?, ?)";
