    ...
    public void execute() throws Exception {
        ...
        try {
            ...
            final String insertQuery = "INSERT INTO " + tableExtractionHeaders.getResultTable() +
                    "(origin_id,group_id,tenant_id,processed_file_path,paper_no, status,stage,message,created_on,process_id,root_pipeline_id,table_response, bboxes, croppedImage,column_headers,truth_entity_name, model_name) " +
                    " VALUES(?,?, ?, ?,?, ?,?,?,? ,?,  ?, ? , ?, ?,?,?,  ?)";
