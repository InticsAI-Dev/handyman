...
public class UrgencyTriageBetaAction implements IActionExecution {
    ...
    public void execute() throws Exception {
        try {
            final Integer writeBatchSize = Integer.valueOf(action.getContext().get(DB_INSERT_WRITE_BATCH_SIZE));
            final Integer consumerCount = Integer.valueOf(action.getContext().get("ut.consumer.API.count"));
            final Integer readBatchSize = Integer.valueOf(action.getContext().get(DB_SELECT_READ_BATCH_SIZE));
