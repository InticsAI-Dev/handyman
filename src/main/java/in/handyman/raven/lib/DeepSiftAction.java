...
public class DeepSiftAction implements IActionExecution {
    ...
    public void execute() throws Exception {
        try {
            ...
            final int consumerApiCount = Optional.ofNullable(DeepSift.getForkBatchSize()).map(Integer::valueOf).orElse(0);            Integer writeBatchSize = Integer.valueOf(action.getContext().get(DB_INSERT_WRITE_BATCH_SIZE));
