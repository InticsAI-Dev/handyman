...
import in.handyman.raven.lib.services.p2pNameValidation.P2PNameValidationInputTable;
import in.handyman.raven.lib.services.p2pNameValidation.P2PNameValidationOutputTable;
import in.handyman.raven.lib.services.p2pNameValidation.P2pNameValidationConsumerProcess;
...
public class P2pNameValidationAction implements IActionExecution {
    ...
    public P2pNameValidationAction(final ActionExecutionAudit actionExecutionAudit, final Logger log, final Object p2pNameValidation) {
        ...
        String writeBatchSizeStr = this.actionExecutionAudit.getContext().get(DB_INSERT_WRITE_BATCH_SIZE);
        ...
        this.p2pUrl = P2P_URL;
        this.readBatchSize = Integer.valueOf(actionExecutionAudit.getContext().get(DB_SELECT_READ_BATCH_SIZE));
    ...
    public void execute() throws Exception {
        try {
            ...
            final String insertQuery = "INSERT INTO " + p2pNameValidation.getOutputTable() +
                    "(origin_id, group_id, b_box, confidence_score, maximum_score, extracted_value, " +
    ...
    private CoproProcessor<P2PNameValidationInputTable, P2PNameValidationOutputTable> getP2PNameValidationInputTableP2PNameValidationOutputTableCoproProcessor(Jdbi jdbi, List<URL> urls) {
        ...
        final CoproProcessor<P2PNameValidationInputTable, P2PNameValidationOutputTable> coproProcessor = new CoproProcessor<>(new LinkedBlockingQueue<>(), P2PNameValidationOutputTable.class, P2PNameValidationInputTable.class, p2pNameValidation.getResourceConn(), log, p2PNameValidationInputTable, urls, actionExecutionAudit);
