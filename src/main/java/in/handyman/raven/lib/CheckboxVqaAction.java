...
public class CheckboxVqaAction implements IActionExecution {
    ...
    public void execute() throws Exception {
        try {
            ...
            coproProcessor.startProducer(checkboxVqa.getQuerySet(), Integer.valueOf(action.getContext().get(DB_SELECT_READ_BATCH_SIZE)));
            Thread.sleep(1000);
            coproProcessor.startConsumer(insertQuery, Integer.valueOf(action.getContext().get("ut.consumer.API.count")), Integer.valueOf(action.getContext().get(DB_INSERT_WRITE_BATCH_SIZE)), new CheckboxVqaConsumerProcess(log, aMarker, action));
    ...
    public static class CheckboxVqaConsumerProcess implements CoproProcessor.ConsumerProcess<CheckboxVqaInputTable, CheckboxVqaOutputTable> {
        ...
        public List<CheckboxVqaOutputTable> process(URL endpoint, CheckboxVqaInputTable entity) throws Exception {
            ...
            try (Response response = httpclient.newCall(request).execute()) {
                ...
                HandymanException.insertException("Blank Page removal consumer failed for origin Id " + originId + " paper No " + paperNo, handymanException, this.action);
