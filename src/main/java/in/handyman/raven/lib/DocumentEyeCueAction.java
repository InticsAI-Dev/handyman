...
import static in.handyman.raven.core.enums.ConsumerApiCountConstants.P6_DOC_EYE_CUE_API;
import static in.handyman.raven.core.enums.DatabaseConstants.DOCUMENT_EYE_CUE_READ_BATCH_SIZE;
import static in.handyman.raven.core.enums.DatabaseConstants.DOCUMENT_EYE_CUE_WRITE_BATCH_SIZE;
...
public class DocumentEyeCueAction implements IActionExecution {
    ...
    public void execute() throws Exception {
        try {
            ...
            Integer consumerApiCount = Integer.valueOf(action.getContext().getOrDefault(P6_DOC_EYE_CUE_API,"40"));
