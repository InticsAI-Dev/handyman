...
import in.handyman.raven.lib.services.neradaptors.NerAdapterDataItem;
import in.handyman.raven.lib.services.neradaptors.NerAdapterPayload;
import in.handyman.raven.lib.services.neradaptors.NerAdapterResponse;
import in.handyman.raven.lib.services.neradaptors.copro.NerAdapterDataItemCopro;
                ...
                nerAdapterResponse.getOutputs().forEach(nerAdapterOutput -> {
                    nerAdapterOutput.getData().forEach(nerAdapterDataItem -> {
                        try {
                            ...
                            throw new HandymanException("Exception in handling the response body of NER adapter", e);
                        }
                    });
                });
            }
