...
import in.handyman.raven.lib.services.filemergerpdf.FileMergerPdfConsumerProcess;
import in.handyman.raven.lib.services.filemergerpdf.FileMergerpdfInputEntity;
import in.handyman.raven.lib.services.filemergerpdf.FileMergerpdfOutputEntity;
...
public class FileMergerPdfAction implements IActionExecution {
    ...
    public void execute() {
        try {
            ...
            Integer writeBatchSize1 = Integer.valueOf(action.getContext().get(DB_INSERT_WRITE_BATCH_SIZE));
            ...
            final String insertQuery = "INSERT INTO " + fileMergerPdf.getOutputTable() + "(origin_id,tenant_id,group_id,processed_file_path,created_on,last_updated_on,root_pipeline_id,status,stage,message,model_name,model_version,file_name,process_id, width, height, dpi, batch_id, request, response, endpoint) " +
