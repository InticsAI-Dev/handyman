...
public class OutboundTableResponseAction implements IActionExecution {
    ...
    public void execute() throws Exception {
        ...
        try {
            ...
            String moduleVariable = "alchemy.outbound.table.url";
            ...
            Thread.sleep(1000);
            coproProcessor.startConsumer(insertQuery, Integer.valueOf(action.getContext().get("alchemy.table.consumer.API.count")), Integer.valueOf(action.getContext().get("write.batch.size")), new OutboundTableConsumerProcess(log, aMarker, action, this), moduleVariable);
