    ...
    public void execute() {
        try {
            ...
            final String insertQuery = "INSERT INTO " + tableExtraction.getResultTable() +
                    "(origin_id,group_id,tenant_id,template_id,processed_file_path,paper_no, status,stage,message,created_on,process_id,root_pipeline_id,table_response, bboxes, croppedImage, model_name,truth_entity_id,sor_container_id,channel_id) " +
                    " VALUES(?,?, ?,?, ?,?, ?,?,?,? ,?,  ?, ? , ?, ?,   ? ,?, ?, ?)";
