...
public class PhraseMatchPaperFilterAction implements IActionExecution {
  ...
  public static final String INSERT_INTO_COLUMNS = "origin_id,group_id,paper_no,truth_entity, synonym, is_key_present,status,stage,message, created_on,root_pipeline_id,model_name,model_version,tenant_id,request,response,endpoint";
