...
import in.handyman.raven.lib.services.autorotation.AutoRotationConsumerProcess;
import in.handyman.raven.lib.services.autorotation.AutoRotationInputTable;
import in.handyman.raven.lib.services.autorotation.AutoRotationOutputTable;
...
public class AutoRotationAction implements IActionExecution {
    ...
    public static final String COLUMN_LIST = "origin_id,group_id,tenant_id,template_id,process_id, processed_file_path,paper_no, status,stage,message,created_on,root_pipeline_id,model_name,model_version,batch_id, last_updated_on,request,response,endpoint";
    ...
    public AutoRotationAction(final ActionExecutionAudit action, final Logger log,
        ...
        this.readBatchSize = Integer.parseInt(action.getContext().get(DB_SELECT_READ_BATCH_SIZE));
        ...
        this.tritonRequestActivator = action.getContext().get(TRITON_REQUEST_ACTIVATOR);
