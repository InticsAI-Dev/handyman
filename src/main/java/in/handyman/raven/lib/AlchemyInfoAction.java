...
public class AlchemyInfoAction implements IActionExecution {
    ...
    public void execute() throws Exception {
        try {
            ...
            coproProcessor.startProducer(alchemyInfo.getQuerySet(), Integer.valueOf(action.getContext().get(DB_SELECT_READ_BATCH_SIZE)));
            Thread.sleep(1000);
            coproProcessor.startConsumer(insertQuery, 1,  Integer.valueOf(action.getContext().get(DatabaseConstants.DB_INSERT_WRITE_BATCH_SIZE)), new AlchemyInfoAction.AlchemyInfoConsumerProcess(log, aMarker, action));
