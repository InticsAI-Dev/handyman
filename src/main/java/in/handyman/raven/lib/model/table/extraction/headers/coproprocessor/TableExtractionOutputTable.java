...
public class TableExtractionOutputTable implements CoproProcessor.Entity {
    ...
    public List<Object> getRowData() {
        return Stream.of(this.originId, this.groupId, this.tenantId, this.processedFilePath,
                this.paperNo, this.status, this.stage, this.message, this.createdOn, this.processId, this.rootPipelineId, this.tableResponse, this.bboxes, this.croppedImage,this.columnHeaders,this.truthEntityName,this.modelName).collect(Collectors.toList());
    }
}
