...
public class DataExtractionOutputTable implements CoproProcessor.Entity {
    ...
    public List<Object> getRowData() {
        return Stream.of(this.originId, this.groupId, this.tenantId,this.templateId
                ...
                ,this.status,this.stage,this.message,this.isBlankPage,this.createdOn,this.rootPipelineId,this.templateName, this.modelName, this.modelVersion, this.request, this.response, this.endpoint).collect(Collectors.toList());
    }
}
