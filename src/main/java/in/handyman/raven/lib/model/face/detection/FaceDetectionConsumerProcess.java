...
public class FaceDetectionConsumerProcess implements CoproProcessor.ConsumerProcess<FaceDetectionQueryInputTable, FaceDetectionQueryOutputTable> {
    ...
    private void extractedCoproOutputResponse(FaceDetectionQueryInputTable entity, String faceDetectionDataItem, List<FaceDetectionQueryOutputTable> parentObj, String s, String s1) {
        Long groupId = entity.getGroupId();
        Long processId = entity.getProcessId();
        ...
        try {
            List<FaceDetectionExtractionResponse> detectionDataItem = mapper.readValue(faceDetectionDataItem, new TypeReference<>() {
            });
