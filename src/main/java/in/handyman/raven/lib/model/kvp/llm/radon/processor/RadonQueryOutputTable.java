...
public class RadonQueryOutputTable implements CoproProcessor.Entity {
    ...
    public List<Object> getRowData() {
        return Stream.of(this.createdOn,this.createdUserId,  this.lastUpdatedOn,this.lastUpdatedUserId,
                ...
                this.modelRegistry, this.status, this.stage, this.message, this.category, this.request, this.response, this.endpoint, this.sorContainerId, this.kryptonInferenceMode).collect(Collectors.toList());
