package in.handyman.raven.lib.model.kvp.llm.radon.processor; // Update with your actual package name
...
/**
 * Processes Radon queries and handles transformations with various options
 * including batch processing and encryption.
 */
public class SorTransactionKvpDoublePass {
    ...
    private static ProviderDataTransformer providerDataTransformer;
    private static String processBase64;
    static ObjectMapper mapper = new ObjectMapper();
    private static OkHttpClient httpclient;

    private static FileProcessingUtils fileProcessingUtils;
    ...
    public SorTransactionKvpDoublePass(Logger log, Jdbi jdbi, Marker aMarker, ActionExecutionAudit action) {
        this.log = log;
        this.jdbi = jdbi;
    ...
    /**
     * Sends a request to the Radon KVP API and handles the response
     *
     * @param endpoint API endpoint URL
     * @param entity Original input data
     * @param parentObj List to store output results
     * @param radonKvpExtractionRequest Request payload
     * @throws Exception If any error occurs during the request
     */
    private static void sendRequest(URL endpoint, RadonQueryInputTable entity, List<RadonQueryOutputTable> parentObj,
    ...
    private static void coproResponseBuilder(RadonQueryInputTable entity, Request request, List<RadonQueryOutputTable> parentObj, String jsonInputRequest, URL endpoint) {
        Long groupId = entity.getGroupId();
        Long processId = entity.getProcessId();
        Long tenantId = entity.getTenantId();
        Integer paperNo = entity.getPaperNo();
        ...
        try (Response response = httpclient.newCall(request).execute()) {
            ...
            HandymanException handymanException = new HandymanException(e);
            HandymanException.insertException("Radon kvp action consumer failed for batch/group " + groupId, handymanException, action);
            log.error(aMarker, "The Exception occurred in getting response from copro server {}", ExceptionUtil.toString(e));
        }
    }

    private static void extractedCoproOutputResponse(RadonQueryInputTable entity, String radonDataItem, List<RadonQueryOutputTable> parentObj, String request, String response, String endpoint) throws JsonProcessingException {
        Long groupId = entity.getGroupId();
        Long processId = entity.getProcessId();
    ...
    public static void tritonRequestBuilder(RadonQueryInputTable entity, Request request, List<RadonQueryOutputTable> parentObj, String jsonRequest, URL endpoint) {
        Long groupId = entity.getGroupId();
        Long processId = entity.getProcessId();
        Long tenantId = entity.getTenantId();
        Integer paperNo = entity.getPaperNo();
    ...
    private static void extractTritonOutputDataResponse(RadonQueryInputTable entity, String radonDataItem, List<RadonQueryOutputTable> parentObj, String request, String response, String endpoint) throws IOException, EvalError {
        Long groupId = entity.getGroupId();
        Long processId = entity.getProcessId();
    ...
    private static List<Map<String, Object>> parseJsonToList(String jsonString, String logIdentifier) {
...
//                    .replace("\\\\", "\\");
            ...
            resultList = obj.readValue(jsonString, new TypeReference<>() {});
     ...
     * @param inputResponseJson JSON to insert at placeholder
     * @param base64Activator Whether to use base64 encoding
     * @param placeholderName Name of the placeholder to replace
     * @param logIdentifier Identifier for logging purposes
     * @return Processed prompt
     */
    private static String processPrompt(String originalPrompt, String inputResponseJson, String base64Activator,
    ...
    /**
     * Process response from Copro API (Legacy mode)
     * Note: You'll need to implement this method based on your application's needs
     */
