...
public class CurrencyDetectionOutputQuerySet implements CoproProcessor.Entity {
    ...
    public List<Object> getRowData() {
        return Stream.of(this.originId, this.groupId, this.tenantId, this.templateId, this.processId,
                ...
                this.modelName, this.modelVersion,this.inputFilePath,this.detectedValue,this.detectedAsciiValue,this.confidenceScore,this.request,this.response,this.endpoint).collect(Collectors.toList());
    }
}
