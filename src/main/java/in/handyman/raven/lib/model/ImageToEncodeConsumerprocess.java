...
//
//public class ImageToEncodeConsumerprocess implements CoproProcessor.ConsumerProcess<ImageToBaseInputTable, ImageToBaseOutputTable> {
//
...
//
//
//    public ImageToEncodeConsumerprocess(Logger log, Marker aMarker, String outputDir, ActionExecutionAudit action) {
//        this.log = log;
...
//
//    @Override
//    public List<ImageToBaseOutputTable> process(URL endpoint, PaperItemizerInputTable entity) throws Exception {
//        return null;
//    }
//
//    @Override
//    public List<ImageToBaseOutputTable> process(URL endpoint, ImageToBaseInputTable entity) throws Exception {
...
//
//        Long rootPipelineId = entity.getTenantId();
//        Long paperNo=entity.getPaperNo();
//        String processedFilePath=entity.getProcessedFilePath();
//        String originId= entity.getOriginId();
//
//        final String paperItemizerProcessName = "ImageToBase64";
