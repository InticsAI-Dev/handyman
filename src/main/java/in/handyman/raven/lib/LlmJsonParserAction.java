...
import in.handyman.raven.lib.model.jsonParser.KVP.KVPOutputTable;
import in.handyman.raven.lib.model.jsonParser.KVP.SORParser;
import in.handyman.raven.lib.model.jsonParser.Table.Table;
    ...
    try {
      ...
      jdbi.useTransaction(handle -> {
        for (LlmJsonQueryInputTable inputTable : inputTableList) {
          ...
          List<LlmJsonParsedResponse> innerParsedResponses = new ArrayList<>();if (Objects.equals(inputTable.getProcess(), "KVP_ATTRIBUTION")) {
        ...
        final String insertQueryText = "INSERT INTO " + llmJsonParser.getOutputTable() +
            ...
            ObjectNode resultWrapper = objectMapper.createObjectNode();
            ArrayNode arrayNode = objectMapper.valueToTree(aggregatedResult);

            resultWrapper.set("textLine", arrayNode);
            ...
            handle.createUpdate(insertQueryText)
                        ...
                        .bind(4, resultWrapper.toString())             // content
            ...
            ObjectNode tables = TableParser.parseTables(jsonResponse);
