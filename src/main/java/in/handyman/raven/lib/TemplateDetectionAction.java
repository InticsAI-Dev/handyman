...
import in.handyman.raven.lib.services.templatedetection.TemplateDetectionConsumerProcess;
import in.handyman.raven.lib.services.templatedetection.TemplateDetectionInputTable;
import in.handyman.raven.lib.services.templatedetection.TemplateDetectionOutputTable;
...
public class TemplateDetectionAction implements IActionExecution {
    ...
    public TemplateDetectionAction(final ActionExecutionAudit action, final Logger log,
        ...
        String readBatchSizeStr = Optional.ofNullable(this.action.getContext().get(DB_SELECT_READ_BATCH_SIZE)).orElse(DEFAULT_BATCH_SIZE);
        String writeBatchSizeStr = Optional.ofNullable(this.action.getContext().get(DB_SELECT_READ_BATCH_SIZE)).orElse(DEFAULT_BATCH_SIZE);
