...
import in.handyman.raven.lib.services.greyscaleconversion.GreyScaleConversionConsumerProcess;
import in.handyman.raven.lib.services.greyscaleconversion.GreyScaleConversionInputQuerySet;
import in.handyman.raven.lib.services.greyscaleconversion.GreyScaleConversionOutputQuerySet;
...
public class GreyScaleConversionAction implements IActionExecution {
    ...
    public static final String COLUMN_LIST = "origin_id,group_id,tenant_id,template_id,process_id, processed_file_path,paper_no, status,stage,message,created_on,root_pipeline_id,model_name,model_version,input_file_path,is_color, batch_id,request,response,endpoint";
