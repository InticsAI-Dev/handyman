  ...
  public void execute() throws Exception {
    ...
    try {
      ...
      final String insertQuery = "INSERT INTO " + masterdataComparison.getMatchResult() +
              "(origin_id, paper_no, eoc_identifier, created_on, actual_value, extracted_value, intelli_match, status, stage, message, root_pipeline_id, model_name, model_version, tenant_id) " +
              "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
