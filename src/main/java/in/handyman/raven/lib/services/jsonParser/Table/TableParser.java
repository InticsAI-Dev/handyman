package in.handyman.raven.lib.services.jsonParser.Table;
...
public class TableParser {
    ...
    public static List<TableContentNode> parseTables(String jsonStr) throws IOException {
        ...
        List<TableContentNode> resultArray = new ArrayList<>();
        ...
        if (tableValues != null && !tableValues.isNull()) {
            ...
            tables.forEach(s -> {
                ...
                tableContent.setBoundingBox(bBox);
