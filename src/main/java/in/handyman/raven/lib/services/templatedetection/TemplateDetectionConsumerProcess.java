package in.handyman.raven.lib.services.templatedetection;
...
import in.handyman.raven.lib.services.templatedetection.copro.TemplateDetectionDataItemCopro;
import in.handyman.raven.lib.services.trinitymodel.TrinityInputAttribute;
            ...
            if (response.isSuccessful()) {
                ...
                outputObjectList.add(
                        TemplateDetectionOutputTable.builder()
                                ...
                                .modelRegistryId(entity.getModelRegistryId())
