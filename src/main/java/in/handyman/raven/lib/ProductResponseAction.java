    ...
    public void execute() throws Exception {
        try {
            ...
            final String insertQuery = "INSERT INTO " + productResponse.getResultTable() +
                    "(process_id,group_id,origin_id,product_response, tenant_id,root_pipeline_id,status,stage,message,feature,triggered_url, batch_id, inbound_transaction_id, created_on, last_updated_on) " +
                    " VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            Thread.sleep(1000);
            int consumerApiCountStr = Integer.parseInt(action.getContext().getOrDefault("alchemy.response.consumer.API.count", "12"));
