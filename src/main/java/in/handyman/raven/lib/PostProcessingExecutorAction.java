...
public class PostProcessingExecutorAction implements IActionExecution {
    ...
    public void execute() throws Exception {
        ...
        List<SpwBshConfig> bshConfigs = ConfigAccess.findAllBshClassesByTenantId(action.getContext().getOrDefault("tenant_id", "0").equals("0") ? null : Long.parseLong(action.getContext().getOrDefault("tenant_id", "1")));
        ...
        PostProcessingFieldsInputs = new ValidatorByBeanShellExecutor(PostProcessingFieldsInputs, action, log, postProcessingThreadCount,bshConfigs).doRowWiseValidator();
