...
@Data
@Builder
public class CustomResponseOutputTable implements CoproProcessor.Entity {
    ...
    public List<Object> getRowData() {
        return Stream.of(this.processId, this.groupId, this.originId, this.customResponse, this.tenantId, this.rootPipelineId,
