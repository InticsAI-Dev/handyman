...
public class DrugMatchAction implements IActionExecution {
  ...
  public void execute() throws Exception {
    ...
    try {
      ...
      coproProcessor.startProducer(drugMatch.getInputSet(), Integer.valueOf(action.getContext().get(DB_SELECT_READ_BATCH_SIZE)));
      log.info(aMarker, "Drug Match coproProcessor startProducer called read batch size {}", action.getContext().get(DB_SELECT_READ_BATCH_SIZE));
      Thread.sleep(1000);
      ...
      log.info(aMarker, "Drug Match coproProcessor startConsumer called consumer count {} write batch count {} ", Integer.valueOf(action.getContext().get("consumer.API.count")), Integer.valueOf(action.getContext().get(DB_INSERT_WRITE_BATCH_SIZE)));
