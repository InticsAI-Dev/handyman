...
public class PaperItemizerAction implements IActionExecution {
    ...
    public void execute() {
        try {
            ...
            Thread.sleep(1000);
            coproProcessor.startConsumer(insertQuery, consumerApiCount, writeBatchSize, new PaperItemizerConsumerProcess(log, aMarker, outputDir, fileProcessingUtils, action, processBase64, paperItemizer), false);
