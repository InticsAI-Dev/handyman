...
public class ValidationLlmAction implements IActionExecution {
  ...
  public void execute() throws Exception {
    try {
      ...
      coproProcessor.startConsumer(insertQuery, consumerApiCount, writeBatchSize, (CoproProcessor.ConsumerProcess<ValidationLlmInputTable, ValidationLlmOutputTable>) validationLlmConsumerProcess);
