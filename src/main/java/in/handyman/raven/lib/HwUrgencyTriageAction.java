...
public class HwUrgencyTriageAction implements IActionExecution {
  ...
  public void execute() throws Exception {
    try {
      ...
      final String insertQuery = "INSERT INTO hw_urgency_triage.hw_triage_transaction(created_on, created_user_id, last_updated_on, last_updated_user_id, tenant_id, model_score, origin_id, paper_no, template_id, model_registry_id, doc_triage_state, status, stage, message)" +
              "values(now(),?,now(),?,?,?,?,?,?,?,?,?,?,?,?)";
