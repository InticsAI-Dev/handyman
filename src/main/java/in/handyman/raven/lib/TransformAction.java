...
import static in.handyman.raven.core.encryption.EncryptionConstants.ENCRYPT_TRANSFORM_QUERY;
...
public class TransformAction implements IActionExecution {
    ...
    public void execute() {
        ...
        boolean transformSqlEncrypter = Boolean.parseBoolean(actionExecutionAudit.getContext().get(ENCRYPT_TRANSFORM_QUERY));
