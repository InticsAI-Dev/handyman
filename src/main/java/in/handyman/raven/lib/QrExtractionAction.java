...
import in.handyman.raven.lib.services.qrextraction.QrConsumerProcess;
import in.handyman.raven.lib.services.qrextraction.QrInputEntity;
import in.handyman.raven.lib.services.qrextraction.QrOutputEntity;
...
public class QrExtractionAction implements IActionExecution {
    ...
    public void execute() throws Exception {
        ...
        String outputDir = action.getContext().get(TARGET_DIRECTORY_PATH) + "/" + qrExtraction.getProcessId() + "/" + QR_EXTRACTION + "/";
