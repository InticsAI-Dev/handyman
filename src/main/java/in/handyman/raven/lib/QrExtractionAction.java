...
public class QrExtractionAction implements IActionExecution {
    ...
    public static final String INSERT_INTO_COLUMNS = "origin_id, group_id, paper_no, created_on,   qr_format, qr_format_id, extracted_value,   file_id, b_box, angle, confidence_score, status, stage, message,decode_type, model_name, model_version,root_pipeline_id,tenant_id, batch_id";
    ...
    public QrExtractionAction(final ActionExecutionAudit action, final Logger log,
        ...
        String httpClientTimeout = action.getContext().get(OKHTTP_CLIENT_TIMEOUT);
    }
    ...
    public void execute() throws Exception {
        ...
        try {
            ...
            Thread.sleep(1000);
            //8. call the method start consumer from copro processor
