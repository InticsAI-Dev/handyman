...
public interface PipelineExecutionAuditRepo {
    ...
    @SqlUpdate("insert into " + DoaConstant.AUDIT_SCHEMA_NAME + DOT + DoaConstant.PEA_TABLE_NAME + "  ( " + COLUMNS + " ) VALUES(\"audit\".\"ISEQ$$_76357\".nextval, :createdBy, :createdDate, :lastModifiedBy, :lastModifiedDate, :contextNode, :executionStatusId, :lambdaName, :parentActionId, :parentActionName, :parentPipelineId, :parentPipelineName, :pipelineName, :fileContent, :hostName, :modeOfExecution, :pipelineLoadType, :relativePath, :requestBody, :threadName, :processName, :rootPipelineId, :processId ) " )
