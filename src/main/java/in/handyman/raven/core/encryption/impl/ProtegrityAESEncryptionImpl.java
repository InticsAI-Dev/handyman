...
public class ProtegrityAESEncryptionImpl implements InticsDataEncryptionApi {

    private final SecretKey secretKey;
    private static final Logger LOGGER = LoggerFactory.getLogger(ProtegrityAESEncryptionImpl.class);
    ...
    @Override
    public String encrypt(String inputReqToken, String encryptionPolicy, String sorItem) throws HandymanException {
        try {
            String inputToken = inputReqToken + encryptionPolicy;
    ...
    public String decrypt(String encryptedToken, String encryptionPolicy, String sorItem) throws HandymanException {
        try {
            ...
            if (decryptedString.endsWith(encryptionPolicy)) {
                ...
                decryptedResString=encryptedToken;
            }
            return decryptedResString;
