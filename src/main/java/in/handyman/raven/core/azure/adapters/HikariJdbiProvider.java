...
public class HikariJdbiProvider {
    ...
    public static final int MIN_IDLE = Integer.parseInt(PropertyHandler.getOrDefault("azure.identity.hcp.minimum.idle","20"));
    public static final int MAX_POOL_SIZE = Integer.parseInt(PropertyHandler.getOrDefault("azure.identity.hcp.max.pool.size","20"));;
    ...
    public static void logHikariMetrics() {
        if (hikariDataSource != null) {
            ...
            if (poolMXBean != null) {
                log.info("HikariCP Metrics - Active Connections: {}, Idle Connections: {}, Total Connections: {}, Threads Awaiting Connection: {}",
