    ...
    void executeProduct() throws Exception {
        ...
        OutboundDeliveryNotify outboundDeliveryNotify = OutboundDeliveryNotify.builder()
                ...
                .querySet("\n" +
                        ...
                        " '' as endpoint,'${outbound.appId}' as app_id,'${outbound.appKeyId}' as app_secret_key,product_json as outbound_json,'Product' as outbound_condition\n" +
    ...
    void executeELV() throws Exception {
        ...
        OutboundDeliveryNotify outboundDeliveryNotify = OutboundDeliveryNotify.builder()
                ...
                .querySet("select ifd.file_name as file_name, '' as file_uri, '' as zip_file_check_sum,\n" +
                        ...
                        "'AES' as encryption_type, ifd.\"uuid\" as \"uuid\" , 'RgF7I3z5FC8k9HkKUm3Htb1HhZPBczdksVr9fqGbTwc=' as encryption_key\n" +
