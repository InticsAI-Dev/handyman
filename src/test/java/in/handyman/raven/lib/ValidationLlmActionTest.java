...
public class ValidationLlmActionTest {
    ...
    public void validationLlmActionTestCopro() throws Exception {
        ValidationLlm validationLlm = ValidationLlm.builder()
                ...
                .outputTable("score.validation_llm_result_table")
                .querySet("select vt.root_pipeline_id , dara.action_id , 'VALIDATION' as process, '/data/input/blank.pdf' as input, '/data/' as output_dir, \n" +
                        ...
                        "vt.synonym_id , vt.answer , vt.vqa_score , vt.weight , vt.created_user_id , vt.tenant_id ,now() , \n" +
                        ...
                        "join score.validation_llm_prompt_value_table_audit vp on vp.origin_id = vt.origin_id and vp.tenant_id = dara.tenant_id and vp.paper_no = vt.paper_no \n" +
