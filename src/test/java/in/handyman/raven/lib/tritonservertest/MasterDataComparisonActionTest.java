...
public class MasterDataComparisonActionTest {
    ...
    void tritonServer() throws Exception {
        final MasterdataComparison build = MasterdataComparison.builder()
                ...
                .inputSet("\n" +
                        "SELECT a.origin_id ,a.paper_no ,a.eoc_identifier,now(), a.provider_address  as extracted_value , 'batch_1' as batch_id ,\n" +
                        "b.provider_address  as actual_value,\n" +
                        ...
                        "WHERE a.group_id='16' and a.tenant_id = 1")
