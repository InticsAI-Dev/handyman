...
//    }
    ...
    void tritonServer() throws Exception {
        DataExtraction dataExtraction = DataExtraction.builder()
                ...
                .processId("138980184199100180")
                .resultTable("info.data_extraction")
                .querySet("SELECT 1 as process_id, 1 as tenant_id, 1 as template_id, 1 as group_id, 'INT-1' as origin_id, 1 as paper_no, " +
                        "'/data/output/cleaned_pipeline/processed_images/03-10-2024_08_10_56/tenant_1/group_406/preprocess/paper_itemizer/pdf_to_image/SYNT_166731563/SYNT_166731563_2.jpg' as file_path, 1 as root_pipeline_id, 'TEXT_EXTRACTOR' as template_name")
                .build();
        ActionExecutionAudit actionExecutionAudit = new ActionExecutionAudit();
        actionExecutionAudit.getContext().put("copro.data-extraction.url", "http://192.168.10.248:8300/v2/models/text-extractor-service/versions/1/infer");
        actionExecutionAudit.setProcessId(138980079308730208L);
        actionExecutionAudit.getContext().putAll(Map.ofEntries(Map.entry("read.batch.size", "5"),
                Map.entry("okhttp.client.timeout", "20"),
                Map.entry("page.content.min.length.threshold", "20"),
                Map.entry("text.extraction.consumer.API.count", "1"),
