...
public class LlmJsonParserActionTest {
    ...
    public void tritonTest() throws Exception {
        LlmJsonParser llmJsonParser = LlmJsonParser.builder()
                ...
                .querySet("SELECT\n" +
                        "                    b.total_response_json as response, b.paper_no,a.origin_id, a.group_id, a.tenant_id, a.root_pipeline_id, a.batch_id,b.sor_item_id,\n" +
                        ...
                        "                    WHERE a.tenant_id = 1 and a.group_id ='151' and a.batch_id ='BATCH-151_0'\n" +
                        "                    group by b.total_response_json,b.sor_item_id, b.paper_no,a.origin_id, a.group_id, a.tenant_id, a.root_pipeline_id, a.batch_id,\n" +
                        "                    b.model_registry, b.category, a.created_on,si.sor_container_id;")
                .build();
