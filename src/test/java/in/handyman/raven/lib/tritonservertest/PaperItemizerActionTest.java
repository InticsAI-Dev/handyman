...
class PaperItemizerActionTest {
    ...
    void tritonServer() throws Exception {
        PaperItemizer paperItemizer = PaperItemizer.builder()
                ...
                .querySet("SELECT 'INT-1' AS origin_id, 1 AS group_id, '/data/input/demo_Sample.pdf' AS file_path, 1 AS tenant_id, 'TMP-1' AS template_id, '138980184199100180' AS process_id, 1 as rootPipelineId \n")
                .build();
