    ...
    void tritonServer() throws Exception {
        PaperItemizer paperItemizer = PaperItemizer.builder()
               ...
               .endpoint("http://192.168.10.248:8100/v2/models/paper-iterator-service/versions/1/infer")
                ...
                .outputDir("/data/data/output/")
                .querySet("SELECT 'INT-1' AS origin_id, 1 AS group_id, '/data/input/2_0.jpg' AS file_path, 1 AS tenant_id, 'TMP-1' AS template_id, '138980184199100180' AS process_id, 1 as rootPipelineId ,'1' as batch_id\n")
                .build();
