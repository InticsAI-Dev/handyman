...
class HwDetectionActionTest {
    ...
    void tritonServer() throws Exception {
        HwDetection hwDetection=HwDetection.builder()
                ...
                .querySet("SELECT 'INT-1' as originId, '1234567' as preprocessedFileId, 1 as paperNo," +
                        "'/data/output/cleaned_pipeline/processed_images/03-10-2024_10_10_24/tenant_1/group_410/preprocess/autorotation/auto_rotation/SYNT_166731563_3.jpg'  as filePath, '123456' as createdUserId, " +
                        "'123456y' as lastUpdatedUserId, '12345643' as tenantId,-1 as templateId, 90.00 as modelScore, 123 as modelRegistryId;")
                .build();
        final ActionExecutionAudit action = ActionExecutionAudit.builder()
                .build();
        action.setRootPipelineId(11011L);
