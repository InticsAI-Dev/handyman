...
public class MedicalPayload {
    ...
    private ExtractedField notificationType;
    @JsonProperty("faxReceivedDate")
    private ExtractedField faxReceivedDate;
    @JsonProperty("totalServiceDays")
    private ExtractedField totalServiceDays;
    @JsonProperty("memberAdditionalProperties")
    private List<AdditionalProperties> memberAdditionalProperties;
}
